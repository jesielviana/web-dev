...
Este curso apresentará as tecnologias da Web e fornecerá experiência na criação de aplicativos da Web. No processo, você aprenderá sobre linguagens de marcação, linguagens de script, protocolos de rede, gráficos interativos, programação orientada a eventos e bancos de dados e verá como todos eles trabalham juntos para fornecer aplicativos interessantes.


No decorrer do curso o aluno vai ver como os conceitos fundamentais do desenvolvimento da Web podem ser aplicados para desenvolver software da Web real, independentemente das tecnologias, idiomas ou estruturas. Embora enfatizemos os conceitos, você demonstrará sua competência no desenvolvimento da Web desenvolvendo software dinâmico da Web com várias linguagens e tecnologias de programação comumente usadas.
...
- Compreender o funcionamento da Web e demonstrar um entendimento do cliente-servidor;
...
- Aplique conceitos de usabilidade a cenários da vida real e sugira potencial melhoria da perspectiva de um engenheiro
- Avalie seu projeto quanto à conformidade com os requisitos do cliente e os critérios de avaliação de usabilidade
